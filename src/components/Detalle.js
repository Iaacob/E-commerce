                        ...
                        <div className="row">
                            ...
                            <div className="col-sm-6">
                                <div className="product-inner">
                                    <h2 className="product-name">{elemento.title}</h2>
                                    ...
                                    <div className="product-inner-category">
                                        <p>Category: <a href="">{elemento.categoria}</a>. Tags: <a href="">awesome</a>, <a href="">best</a>, <a href="">sale</a>, <a href="">shoes</a>. </p>
                                    </div> 
