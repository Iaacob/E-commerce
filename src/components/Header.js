                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-sm-6">
                            ...
                            <Link to="/cart">Cart - <span class="cart-amunt">$5</span> <i class="fa fa-shopping-cart"></i> <span class="product-count">5</span></Link></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="container-fluid">
                    <div className="collapse navbar-collapse" style={{ justifyContent: 'center' }}>
                        <ul className="nav navbar-nav">
                            ...
                            {/* <li className="nav-item">
                                <Link className="active" aria-current="page" to="/SingleProduct">Single product</Link>
                            </li> */}
                            {/* <li className="nav-item">
